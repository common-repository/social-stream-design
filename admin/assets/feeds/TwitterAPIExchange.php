...
class TwitterAPIExchangeWP {
	...
	public function performRequest( $return = true, $curl_options = array() ) {
		...
		if ( in_array( strtolower( $this->request_method ), array( 'put', 'delete' ) ) ) {
			$curl_options[ CURLOPT_CUSTOMREQUEST ] = $this->request_method;
		}
		...
		$this->http_status_code = curl_getinfo( $feed, CURLINFO_HTTP_CODE );
	 ...
	 * @param array  $curl_options curl_options.
	 *
	 * @throws \Exception Exception.
	 *
	 ...
	 * @return integer
	 */
	public function getH_stpSta_cusCode() {
